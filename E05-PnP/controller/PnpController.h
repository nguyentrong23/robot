...
#define PICK_POINT_HIGH_OFFSET          120
#define ROTATE_POINT_HIGH_OFFSET        50
#define ROTATE_POINT_Y_OFFSET_PUTIN     -50
#define ROTATE_POINT_Y_OFFSET_PUTOUT    0
#define PLACE_POINT_HIGH_OFFSET         200
#define PLACE_POINT_X_OFFSET            80
#define SET_OVERIDE                     100
#define NUMBER_OBJECTS_FOUND            1
...
public:
  ...
  int getTotalObjectPicked();
  void setTotalObjectPicked(int value);
...
public:
  ...
  const int pgc_grip_close_pos_ = 1/*0*/;

  const int wait_feeding_time_ = 1000;//1500;
  const int wait_plate_scatt_time_ = 3000;
  const int wait_plate_upper_time_ = 2000;//3000;
