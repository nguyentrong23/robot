...
#define LINEAR_POSITION_MAX     5000
#define LINEAR_POSITION_MIN     0
#define LINEAR_FORCE_MAX       100
#define LINEAR_FORCE_MIN       20
#define LINEAR_SPEED_MAX       100
#define LINEAR_SPEED_MIN       0
...
enum DhLinearStatus : int {
    kLinearInMotion = 0,
    kLinearAtPosition = 1,
    kLinearBlockedMotion = 2
};

static QString EnumConvert(DhLinearStatus enum_code) {
    QString state_string = "enum code invalid: " + enum_code;
    switch (enum_code) {
    case DhLinearStatus::kLinearInMotion:
        state_string = "In motion";
        break;
    case DhLinearStatus::kLinearAtPosition:
        state_string = "Arrived position";
        break;
    case DhLinearStatus::kLinearBlockedMotion:
        state_string = "Blocked motion";
        break;
    default:
        state_string = "Unknown";
        break;
