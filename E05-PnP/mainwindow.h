...
//  void PnpDisplayMatchingImage();
  ...
  /// BUTTON ACTIONS
  void on_Click_Dashboard_AllConnect();
  void on_Click_Dashboard_AllDisConnect();
  void on_Click_Dashboard_Start();
  void on_Click_Dashboard_Stop();
  void on_Click_Dashboard_Check();
  void on_Click_Dashboard_Counter_Reset();
...
private:
  ...
  QString robotAddress = "192.168.1.177";;
  ...
  QString plateAddress = "192.168.1.247";
  int plateServerPort = 502;
