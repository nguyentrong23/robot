...
QString FxRemote::FxPlcGetIpAddress() {
    return plc_address_;
}
int FxRemote::FxPlcGetPort() {
    return plc_server_port_;
}

void FxRemote::FxPlcSetIpAddress(QString ipAddress) {
    plc_address_ = ipAddress;
}
void FxRemote::FxPlcSetPort(int port) {
    plc_server_port_ = port;
}
