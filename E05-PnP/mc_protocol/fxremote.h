...
public:
  ...
  QString FxPlcGetIpAddress();
  int FxPlcGetPort();
  void FxPlcSetIpAddress(QString ipAddress);
  void FxPlcSetPort(int port);
  QString plc_address_ = "192.168.1.250";
  int plc_server_port_ = 10000;
